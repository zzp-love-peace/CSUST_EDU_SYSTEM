...
class SchoolNoticeService extends BaseService{
  ...
  /// [onDataFail] 获取数据失败回调
  void getNoticeDetail(String cookie,String ggid,{required OnDataSuccess<KeyMap> onDataSuccess,
    OnDataFail? onDataFail}){
    var params = FormData.fromMap({
      KeyAssets.cookie: cookie,
      KeyAssets.ggid: ggid,});
    post(UrlAssets.getNoticeDetail, params: params,onDataSuccess: onDataSuccess,onDataFail: onDataFail);
  }
}